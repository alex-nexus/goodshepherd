  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved meeting as @meeting" do
        ...
        post :create, {:meeting => { "church_id" => "invalid value" }}, valid_session
        assigns(:meeting).should be_a_new(Meeting)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested meeting" do
        ...
        Meeting.any_instance.should_receive(:update_attributes).with({ "church_id" => "1" })
        put :update, {:id => meeting.to_param, :meeting => { "church_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the meeting as @meeting" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Meeting.any_instance.stub(:save).and_return(false)
        put :update, {:id => meeting.to_param, :meeting => { "church_id" => "invalid value" }}, valid_session
        assigns(:meeting).should eq(meeting)
      end
