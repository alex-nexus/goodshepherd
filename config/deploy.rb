...
role :web, "prototype.com"                          # Your HTTP server, Apache/etc
role :app, "prototype.com"                         # This may be the same as your `Web` server
role :db,  "prototype.com"   , :primary => true # This is where Rails migrations will run
